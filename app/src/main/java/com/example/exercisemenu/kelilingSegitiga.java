...
public class kelilingSegitiga extends AppCompatActivity {
    ...
    private void hitung() {
        ...
        double s = Integer.parseInt(edits.getText().toString());
        double yaitu = alas + tinggi + s;
        hasil.setText("Keliling Segitiga dengan BC: "+ alas + " AB: " + tinggi + " AC: " + s +" adalah " +yaitu);
    }
}
